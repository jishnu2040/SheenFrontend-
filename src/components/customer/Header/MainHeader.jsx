      ...
      <div className='flex justify-end items-center col-span-6'>
        {user ? (
          <div className='flex items-center'>
            ...
            <button onClick={handleLogout} className='bg-red-500 font-bold text-white px-4 py-2 rounded-lg'>Logout</button>
            <button onClick={handleProfile} className='bg-green-500 font-bold text-white px-4 py-2 rounded-lg ml-2'>Profile</button>
          </div>
        ) : (
          <Link to="/login" className='bg-blue-500 font-bold text-white px-4 py-2 rounded-lg'>
            Login
          </Link>
        )}
      </div>
